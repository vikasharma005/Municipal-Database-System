...
public class Admin implements ActionListener {
    ...
    Admin() {
        ...
        connection = MySqlConnection.dbConnector(); // Setting up the connection to MySQL
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == showButton) {
            af.setVisible(false);
            new LoadDBAdmin(connection); // Pass the MySQL connection to the LoadDBAdmin constructor
        }
        if (e.getSource() == addButton) {
            af.setVisible(false);
            new Add(); // Pass the MySQL connection to the Add constructor
        }
        if (e.getSource() == deleteButton) {
            af.setVisible(false);
            new Delete(connection); // Pass the MySQL connection to the Delete constructor
        }
        if (e.getSource() == modifyButton) {
            af.setVisible(false);
            new Modify(); // Pass the MySQL connection to the Modify constructor
        }
    }
}
